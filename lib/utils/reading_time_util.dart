class ReadingTimeUtil {
  ...
  static String calculateReadingTime(String content, {int wordsPerMinute = averageWordsPerMinute}) {
  ...
  static Duration getReadingDuration(String content, {int wordsPerMinute = averageWordsPerMinute}) {
    final wordCount = getWordCount(content);
    final minutes = (wordCount / wordsPerMinute).ceil();
