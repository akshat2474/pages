...
class DailyContentService {
  ...
  static Future<DailyContentModel> createOrUpdateDailyContent(
  ...
  static Future<List<DailyContentModel>> getRecentDailyContent({
    int limit = 7,
  }) async {
    try {
      final response = await _client
      ...
      return response
          .map<DailyContentModel>((json) => DailyContentModel.fromJson(json))
          .toList();
    } catch (e) {
